...
if (isset($_POST['submit'])) {
    ...
    if (empty($error)) {
        ...
        if ($thumbnail['error'] == 0) {
            ...
            $file_name = $thumbnail['name'] . time() . '.' . $extensions;
            move_uploaded_file($thumbnail['tmp_name'], "$dir_uploads/$file_name");
        }
        $sql_insert = "INSERT INTO news(title, metatitle, description, metades, posts, thumbnail)
                        VALUES ('$title', '$meta_title', '$description', '$meta_des', '$post', '$file_name')";
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <hr>
            <h4>Meta Title :</h4>
            <input type="text" name="metaTitle" style="width: 100%; height: 30px;">
            <hr>
            <h4>Mô tả :</h4>
            <textarea name="description" style="width: 100%; height: 15%"></textarea>
            <hr>
            <h4>Mô tả ngắn :</h4>
            <textarea name="metaDes" style="width: 100%; height: 10%"></textarea>
            <hr>
            <h4>Bài viết :</h4>
                <div class="Posts">
